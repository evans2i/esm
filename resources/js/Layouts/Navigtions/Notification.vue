<template>
    <div class="intro-x dropdown mr-4 sm:mr-6">
        <div @click="isYes = !isYes" class="dropdown-toggle notification notification--light notification--bullet cursor-pointer"> <i class="feather icon-bell notification__icon dark:text-gray-300"></i> </div>
        <div class="notification-content pt-2 upddown-box" :class="{'show':isYes}">
            <div class="notification-content__box upddown-box__content box dark:bg-dark-6">
