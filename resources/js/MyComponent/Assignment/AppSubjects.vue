                ...
                <div class="intro-y box">
                    ...
                    <div class="p-5" id="input">
                        <div class="preview">
                            ...
                            <div class="w-full border-t border-gray-200 dark:border-dark-5 mt-1 border-dashed"></div>
                            <div class="w-full border-t border-gray-200 dark:border-dark-5 mt-2"> </div>
                            <label for="semester_if" class=""> Select Semester</label>
                            <v-select v-model="form.semester_id" :options="semesters" :reduce="semester => semester.id" :filterable="true" class="input w-full border mt-2" ></v-select>

                            <div class="w-full border-t border-gray-200 dark:border-dark-5 mt-1 border-dashed"></div>
                            <div class="w-full border-t border-gray-200 dark:border-dark-5 mt-2"> </div>
                            <label for="subject_id" class=""> Select Subject</label>
                            <v-select v-model="form.subject_id" :options="subjects" :reduce="subject => subject.id" :filterable="true" class="input w-full border mt-2" ></v-select>

                            <div class="w-full border-t border-gray-200 dark:border-dark-5 mt-1 border-dashed"></div>
                            <div class="w-full border-t border-gray-200 dark:border-dark-5 mt-2"> </div>
                            <label for="staff_id" class=""> Select Staff</label>
                     ...
                     <table class="table">
                         ...
                         <tbody>
                             <tr class="hover:bg-gray-200" v-for="(van,index) in angs" :key="index">
                                 ...
                                 <td class="border" v-if="van.subject">{{ van.subject }}</td>
                                 <td class="border" v-else >no subject</td>
    ...
    export default {
        ...
        data() {
            return {
                ...
                semesters:this.vans.semester.data,
                subjects:this.vans.subject.data,
        ...
        methods: {
            ...
            saveDetail(){
                if (this.form.faculty_id == "" || this.form.staff_id == "" || this.form.year_id == "" || this.form.subject_id =="" ) {
                    ...
                    this.form.post(`/manage/${this.urls}`)
                        .then((data) => {
                            if(data.data[1] == "nothing"){
                                Swal.fire("Not Processed!", "Data already added you don't need to add again", "error");
                            }else{
