        ...
        methods: {
            ...
            submitBookToBeTaken(){
                if (this.form.dataBooks.length == 0 || this.form.dataBooks == undefined) {
                    ...
                    this.form.post('/library/storeStaff').then((data)=>{
                    })
                }
            ...
            checkAndValidateData(index){
                ...
                if(total > 20){
                    this.form.dataBooks[index].idadi = "";
                    Swal.fire("Sorry I Can Not Process Data!", `Cant Add More than 20 `, "error");
                }
                if(this.form.dataBooks[index].availablebook < this.form.dataBooks[index].idadi){
                    let rql = this.form.dataBooks[index].idadi;
                    this.form.dataBooks[index].idadi = "";
                    Swal.fire("Sorry I Can Not Process Data!", `${this.form.dataBooks[index].availablebook} Available Book is less than ${rql}  `, "error");
                }
