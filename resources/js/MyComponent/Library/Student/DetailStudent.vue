    ...
    <div class="col-span-12 mt-8">
        <div class="intro-y flex items-center h-10">
            <h2 class="text-lg  font-medium truncate mr-5">
                General Report for <u class="block mt-1 font-extrabold">{{student.name}}</u>
            </h2>
        ...
        <student-show v-show="profile" :studentData="student"></student-show>

        <book-taken v-show="takenbook" :bookTaken="bookTaken" :member="libmember" ></book-taken>

        <issue-book v-show="givebook" :member="libmember"></issue-book>
...
<script>
    import StudentShow from "@/Customers/StudentShow";
    import BookTaken from "@/MyComponent/Library/Student/BookTaken";
    import IssueBook from "@/MyComponent/Library/Student/IssueBook"
    export default {
        components: {StudentShow,BookTaken,IssueBook},
