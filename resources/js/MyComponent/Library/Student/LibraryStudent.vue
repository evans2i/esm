                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="border border-b-2 dark:border-dark-5 whitespace-no-wrap">Identification</th>
                        ...
                        <tbody>
                            <tr class="hover:bg-gray-200" v-for="(van,index) in dataDisplaying" :key="index" @click="viewStudentBook(van.id,pagetitle)" >
