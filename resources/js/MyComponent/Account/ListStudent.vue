    ...
    <div>
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-0 lg:mt-5  sm:mt-3 mt-5">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                ...
                <button v-show="addingFee" @click="changeToViewStudent" class="button text-white shadow-md mr-2" :class="addingTheme" >{{ txtDiplay }}</button>

            </div>
        </div>

        <div v-show="addingFee" >
            <loading-spinner v-if="studentMaster.length === 0" >Fetching</loading-spinner>
        </div>

        <div class="grid grid-cols-1 gap-1 gap-1 lg:mt-5" id="printablefull" v-show="addingFee">
            <div class="intro-y box px-5 pt-5">
                <user-printer v-if="Object.keys(studentData).length !== 0" :studentId="studentData.id"></user-printer>
...
<!--                </div>-->
        ...
        <div class="grid grid-cols-1 gap-1 lg:mt-5" v-show="!addingFee">
            <!-- BEGIN: Input -->
                            ...
                            <div class="preview">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="table table--sm">
                                        ...
                                        <tbody>
                                            <tr v-for="(student, inde) in students" :key="inde">
                                                <td class="border-b dark:border-dark-5">
                                                    {{ inde + 1 }}
                                                </td>
                                                <td class="border-b dark:border-dark-5">{{student.faculty}}</td>
                                                <td class="border-b dark:border-dark-5">{{student.semester}}</td>
                                                <td class="border-b dark:border-dark-5">{{student.reg_no}}</td>
                                                <td class="border-b dark:border-dark-5">{{student.name}}</td>
                                                <td class="border-b dark:border-dark-5">
                                                  <a @click="takeTotheStudentFeeData(student.student_id)">
...
<script>
    ...
    import LoadingSpinner from '@/Customers/LoadingSpinner.vue'
    ...
    export default {
        ...
        data() {
            return {
                ...
                students:this.vans.students.data,
                semesters:[],
