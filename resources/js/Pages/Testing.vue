            ...
            <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                ...
                <div class="flex mt-5 sm:mt-0">
                    ...
                    <div class="dropdown w-1/2 sm:w-auto">
                        <button @click="isYes = !isYes" class="dropdown-toggle button w-full sm:w-auto flex items-center border text-gray-700 dark:bg-dark-5 dark:text-gray-300"> <i data-feather="file-text" class="w-4 h-4 mr-2"></i> Export <i data-feather="chevron-down" class="w-4 h-4 ml-auto sm:ml-2"></i> </button>
                        <div class="upddown-box w-40" :class="{'show':isYes}">
                            <div class="upddown-box__content box dark:bg-dark-1 p-2">
...
<script>
    ...
    import SimpleCrud from '@/Customers/SimpleCrud'
