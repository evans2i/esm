        ...
        methods:{
            ...
            findExamResult(){
                ...
                if(this.form.semester_id !=="" && this.form.semester_id !== undefined){
                    axios.get(`/accademic/findExamResult/${this.form.year_id}/${this.form.faculty_id}/${this.form.semester_id}`).then((data)=>{
                        appBus.fire('fetching-exam', data.data)
                    });
                }
            ...
            changeDataBasedOnBatch(){
                ...
                appBus.fire('fetching-exam', this.results);
            },
