...
{{--    <link rel="stylesheet" href="https://unpkg.com/tailwindcss/dist/tailwind.min.css" />--}}
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, blue 0%, #9997da 100%);
        }
    </style>
</head>
...
<body class="font-sans antialiased text-white gradient" >
    <div id="app">
        <div id="header" class="headering fixed w-full mobile-menu md:hidden">
        ...
        <!--Nav-->
        <nav id="header" class="headering w-full fixed top-nav top-0 text-white">
            <ul  class="headering w-full  justify-end flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0  lg:bg-transparent text-black p-4 lg:p-0 z-20">
                ...
                <li>
                    <inertia-link href="/dashboard"  class="top-menu" style="cursor:pointer;" >
